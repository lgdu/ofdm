...
#define _ssdm_op_FifoRead(fifo) (*(f))
#define _ssdm_op_FifoWrite(fifo, data) ((*(f)) = data)
#define _ssdm_op_WireRead(fifo) (*(f))
#define _ssdm_op_WireWrite(fifo, data) ((*(f)) = data)

#define _ssdm_FifoRead(f) _ssdm_op_FifoRead(f)
#define _ssdm_FifoWrite(fifo, data) _ssdm_op_FifoWrite(fifo, data)
#define _ssdm_op_read(f, x) _ssdm_op_FifoRead(f);  _ssdm_op_Wait(1)
#define _ssdm_op_write(f, x) _ssdm_op_FifoWrite(f, x); _ssdm_op_Wait(1)
...
extern "C" {
    ...
    void _ssdm_op_FifoRead(...) SSDM_OP_ATTR;
    void _ssdm_op_FifoWrite(...) SSDM_OP_ATTR;
    ...
    void _ssdm_op_SpecBus(...) SSDM_SPEC_ATTR;
    void _ssdm_op_SpecFifo(...) SSDM_SPEC_ATTR;
    void _ssdm_op_SpecWire(...) SSDM_SPEC_ATTR;
    void _ssdm_op_SpecBuff(...) SSDM_SPEC_ATTR;
    void _ssdm_op_SpecMem(...) SSDM_SPEC_ATTR;
